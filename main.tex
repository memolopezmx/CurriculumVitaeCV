...
\begin{minipage}[t]{0.375\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{MapMarker}{12}{Priv. la Venta No. 57 Col. San Pablo Xochimehuacan, Puebla, Pue.}\\
	\icon{Phone}{12}{222 780 2098}\\
	\icon{At}{12}{\href{mailto:memo.lopez.mx@gmail.com}{memo.lopez.mx@gmail.com}}\\	
	\icon{Github}{12}{\href{https://github.com/ginppian}{github.com/memolopezmx}}\\
\end{minipage}
...
%\begin{document} % 40% of the page width for the introduction text
	%\vspace{-\baselineskip} % Required for vertically aligning minipages
